...
<head>
    ...
    <title>GHN HR Leader Workshop: AI trong Chuyển đổi Nguồn Nhân lực</title>
    ...
    <style>
        ...
        .ghn-orange { color: #E53935; }
        .ghn-orange-bg { background-color: #E53935; }
        .ghn-orange-border { border-color: #E53935; }
        .ghn-secondary-bg { background-color: #FFF3F2; }
        
        .hero-bg { background-color: #f7f8fa; }
...
<body class="antialiased">
    ...
    <header class="hero-bg">
        ...
        <div class="container mx-auto px-6 pt-16 pb-24 grid lg:grid-cols-2 gap-12 items-center">
            <div class="text-center lg:text-left">
                <p class="font-semibold ghn-orange mb-2 scroll-animate">AI TRONG CHUYỂN ĐỔI NGUỒN NHÂN LỰC</p>
                <h1 class="text-4xl md:text-5xl font-extrabold leading-tight mb-4 text-slate-900 scroll-animate" style="transition-delay: 150ms;">Định hình Tương lai<br/>Ngành Nhân sự bằng AI</h1>
                <p class="text-lg text-slate-600 max-w-lg mx-auto lg:mx-0 mb-8 scroll-animate" style="transition-delay: 300ms;">
                    Chuỗi workshop 6 buổi chuyên sâu giúp đội ngũ HR tại GHN khai phá tiềm năng của Trí tuệ Nhân tạo để trở thành đối tác chiến lược trong kỷ nguyên số.
                </p>
                <div class="scroll-animate" style="transition-delay: 450ms;">
             ...
             <div class="grid md:grid-cols-2 gap-10 items-center">
                ...
                <div class="bg-white p-8 rounded-xl shadow-lg">
                    <form>
                        ...
                        <div class="mb-6">
                            <label for="department" class="block text-sm font-medium text-slate-700 mb-1">Bộ phận</label>
